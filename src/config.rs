...
pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "ll123456".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.222.26.40"];
pub const RS_PUB_KEY: &str = "amDNtKXaoFBjeGlDIPy7E9ntevFWUdxd3I5CfckJCQs=";
